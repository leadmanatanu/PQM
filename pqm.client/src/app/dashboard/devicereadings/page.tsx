...
// Type for device log entry
interface DeviceLog {
    [key: string]: any;
}

export default function Page(): React.JSX.Element {
    const [loading, setLoading] = useState<'devices' | 'parameters' | 'search' | null>('devices');
    ...
    useEffect(() => {
        const loadDevices = async () => {
            ...
            try {
                ...
                setDevices(fetchedDevices ?? []); // default empty array
