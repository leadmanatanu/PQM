            ...
            for (int attempt = 1; attempt <= maxRetries; attempt++)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        Console.WriteLine($"[DLMS Reader] Read attempt {attempt} failed with error {reply.Error}. Retrying...");
                        Thread.Sleep(500);
                    }
                }
                catch (Exception ex)
                {
                    ...
                    Console.WriteLine($"[DLMS Reader] Read attempt {attempt} threw exception: {ex.Message}. Retrying...");
                    Thread.Sleep(500);
                }
            }
